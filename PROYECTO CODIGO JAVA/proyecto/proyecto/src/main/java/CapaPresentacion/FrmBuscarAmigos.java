 ...
 * @author Ena
 */
public class FrmBuscarAmigos extends javax.swing.JFrame {

    CN_Usuario usuario = new CN_Usuario(); 
    /**
     * Creates new form FrmEnvioSolicitudes
     */
    public FrmBuscarAmigos() {
        initComponents();
   ...
   // Función para actualizar la tabla con los datos del usuario
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBuscarAmigos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuscarAmigos().setVisible(true);
            }
        });
    }
